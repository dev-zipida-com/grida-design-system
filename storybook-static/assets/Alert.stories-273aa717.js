import{j as e,a as u}from"./jsx-runtime-68f49b4e.js";import{A as j,a as S,b as k,c as W,d as $}from"./index.esm-d66c4e4b.js";import"./index-f1f749bf.js";import"./_commonjsHelpers-042e6b4d.js";const z={success:{style:"alert-success",icon:S},warning:{style:"alert-warning",icon:k},error:{style:"alert-error",icon:W},info:{style:"alert-info",icon:$}};function t({message:o,type:b="info",showIcon:N=!1,icon:w,description:i,closable:q,closeIcon:V,closeText:I,banner:_=!1,action:c,onClose:s,afterClose:l,size:x="small"}){const B=z[b],R=T=>{s==null||s(T),l==null||l()};return e("div",{className:`alert ${B.style} ${_?"alert-banner":"alert-default"} ${x==="large"?"alert-large":"alert-small"}`,children:[e("header",{className:"alert-header",children:[e("section",{className:"title",children:[N&&(w||u(B.icon,{className:"icon"})),u("span",{children:o})]}),e("section",{className:"extra",children:[c&&u("nav",{children:c}),q&&u("button",{className:"cursor-pointer",onClick:R,children:V||I||u(j,{})})]})]}),i&&u("section",{className:"alert-description",children:i})]})}try{t.displayName="Alert",t.__docgenInfo={description:`피드백에 대한 알림 컴포넌트입니다.
...
옵션: small, large입니다.
배너 모드에서는 기본값이 large이며, 그 외에는 기본값이 small입니다.`,name:"size",required:!1,type:{name:"enum",value:[{value:'"large"'},{value:'"small"'}]}}}}}catch{}const Y={title:"Components/Alert",component:t,tags:["autodocs"],argTypes:{}},C={args:{type:"success",message:"Default"}},a={args:{type:"info",banner:!0,message:"Banner"}},r={args:{type:"warning",message:"Warning",description:"Description Description Description Description Description Description",showIcon:!0}},n={args:{type:"error",message:"Error",showIcon:!0,closable:!0}};var p,d,m;C.parameters={...C.parameters,docs:{...(p=C.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
    type: 'success',
    message: 'Default'
  }
...
//# sourceMappingURL=Alert.stories-273aa717.js.map
