 ...
 * ```
 */
export default function Alert({ message, type, showIcon, icon, description, closable, closeIcon, closeText, banner, action, onClose, afterClose, size, }: AlertProps): JSX.Element;
